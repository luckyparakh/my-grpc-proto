...
type Cart struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CartUuid      string                 `protobuf:"bytes,1,opt,name=cart_uuid,json=cart_id,proto3" json:"cart_uuid,omitempty"`
...
const file_proto_transaction_cart_proto_rawDesc = "" +
	...
	"item_price\x12\x18\n" +
	"\ataxable\x18\x04 \x01(\bR\ataxable\"O\n" +
	"\x04Cart\x12\x1a\n" +
	"\tcart_uuid\x18\x01 \x01(\tR\acart_id\x12+\n" +
	"\x05items\x18\x02 \x03(\v2\x15.transaction.CartItemR\x05itemsB>Z<github.com/luckyparakh/my-grpc-proto/protogen/go/transactionb\x06proto3"
